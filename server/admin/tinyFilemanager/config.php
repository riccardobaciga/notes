...
$auth_users = array(
    'admin' => '$2y$10$ilvGDnt8.djt15ou4e.K7ON5m6HfIyhjOiVzbFnAAq0lGGGWWNG12', //Salite@2022
...
$root_path = dirname(dirname(realpath(__FILE__)).DIRECTORY_SEPARATOR."..".DIRECTORY_SEPARATOR."..".DIRECTORY_SEPARATOR."..".DIRECTORY_SEPARATOR."..").DIRECTORY_SEPARATOR;
// $root_path = baseDir;
